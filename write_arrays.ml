...
let write_arrays data fmt = 
 ...
 | OH -> 
    Npy.write data.train_ctx "Data/oh3_train_ctxs.npz";
    Npy.write data.train_ctx_n "Data/oh3_train_ctxs_n.npz";
    Npy.write data.train_goals "Data/oh3_train_goals.npz";
    Npy.write data.train_goals_n "Data/oh3_train_goals_n.npz";
    Npy.write data.train_meta "Data/oh3_train_meta.npz";
    Npy.write2 data.train_labels "Data/oh3_train_labels.npz";

    Npy.write data.train_premise_ctx "Data/oh3_train_premise_ctxs.npz";
    Npy.write data.train_premise_ctx_n "Data/oh3_train_premise_ctxs_n.npz";
    Npy.write data.train_premise_goals "Data/oh3_train_premise_goals.npz";
    Npy.write data.train_premise_goals_n "Data/oh3_train_premise_goals_n.npz";
    Npy.write data.train_premise_meta "Data/oh3_train_premise_meta.npz";

    Npy.write data.test_ctx "Data/oh3_test_ctxs.npz";
    Npy.write data.test_ctx_n "Data/oh3_test_ctxs_n.npz";
    Npy.write data.test_goals "Data/oh3_test_goals.npz";
    Npy.write data.test_goals_n "Data/oh3_test_goals_n.npz";
    Npy.write data.test_meta "Data/oh3_test_meta.npz";
    Npy.write2 data.test_labels "Data/oh3_test_labels.npz";

    Npy.write data.test_premise_ctx "Data/oh3_test_premise_ctxs.npz";
    Npy.write data.test_premise_ctx_n "Data/oh3_test_premise_ctxs_n.npz";
    Npy.write data.test_premise_goals "Data/oh3_test_premise_goals.npz";
    Npy.write data.test_premise_goals_n "Data/oh3_test_premise_goals_n.npz";
    Npy.write data.test_premise_meta "Data/oh3_test_premise_meta.npz";
